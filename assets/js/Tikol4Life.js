...
function credits(){if(!$("#footer").length){$("#container").append('<div class="footer" id="footer"><center><p style="color: #FFFFFF">CHECKER CCN & CCV</p></center></div>');}else{var x = document.getElementById("footer").textContent;if (x != 'Tikol4Life') {$("#container").append('<div class="footer" id="footer"><center><p style="color: #FFFFFF">CHECKER CCN & CVV</p></center></div>');}}}
